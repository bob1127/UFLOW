...
const aboutFAQs = [
  ...
  {
    question: "UFLOW 公司地址與統一編號是什麼？",
    answer: `慶安有福有限公司（UFLOW）營業所位於${BUSINESS.fullAddress}，統一編號 ${BUSINESS.taxID}。客服電話 ${BUSINESS.telephone}，信箱 ${BUSINESS.email}。`,
  },
];
...
export default function AboutPage() {
  ...
  const schemaFAQ = buildFaqSchema(aboutFAQs, SITE_URL, "/about/#faq");

  // LocalBusiness 再補一份指向 about 頁（方便 Google 將 about 視為商家資訊頁）
